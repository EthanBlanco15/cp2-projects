...
def main(): #Main user interface
    while True:
        ...
        if pers_finan_opt == "what": #Different choices that go into the different functions.
            ...
            if confirmation == "Y" or "y": #Goes into the separate code.
                break
            elif confirmation == "N" or "n": #Sends the user back to main.
            ...
            if continuation == "Y" or "y": #Goes into the separate imported code.
                break
            elif continuation == "N" or "n": #Sends the user back to main.
            ...
            if follow_up == "Y" or "y": #Goes into the separate imported code.
                break
            elif follow_up == "N" or "n": #Sends the user back to main.
            ...
            if question == "Y" or "y": #Goes into the separate imported code.
                break
            elif question == "N" or "n": #Sends the user back to main.
            ...
            if go == "Y" or "y": #Goes into the separate imported code.
                break
            elif go == "N" or "n": #Sends the user back to main.
            ...
            if now == "Y" or "y": #Goes into the separate imported code.
                break
            elif now == "N" or "n": #Sends the user back to main.
